...
function AiAssistantPage() {
  return (
    <PageShell subtitle="Your future finance companion" title="AI Assistant">
      <Card className="rounded-2xl border-border/60 p-6 shadow-[var(--shadow-soft)] sm:p-10">
        <div className="mx-auto max-w-xl text-center">
          ...
          <h2 className="font-display mt-2 text-2xl font-semibold tracking-tight">
            A simpler way to ask about your money
          </h2>
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            The assistant is not enabled in this frontend prototype yet. You can still explore every
            calculation through the dashboard and analytics views.
          </p>
          <div className="mt-7 space-y-3 text-left">
            <div className="flex items-center gap-3 rounded-xl bg-muted/50 p-4">
              <MessageCircle className="h-5 w-5 shrink-0 text-primary" />
              <span className="text-sm text-muted-foreground">
                Ask about trends, budgets and upcoming payments.
              </span>
            </div>
            <div className="flex items-center gap-3 rounded-xl bg-muted/50 p-4">
              <LockKeyhole className="h-5 w-5 shrink-0 text-primary" />
              <span className="text-sm text-muted-foreground">
                Your current workspace stays local to this browser.
              </span>
            </div>
          </div>
